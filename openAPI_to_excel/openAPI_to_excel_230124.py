...
while start_date <= last_date:
    ...
    if val:
        jsonString = json.dumps(
            dict['responseXml']['header'], ensure_ascii=False)
        jsonObj = json.loads(jsonString)
    else:
        jsonString = json.dumps(
            dict['responseXml']['body'], ensure_ascii=False)
        jsonObj = json.loads(jsonString)
...
if __name__ == "__main__":
    merge_excel_files(file_path="./", file_format=".xlsx",
                      save_path="./merge_excel_now.xlsx", save_format=".xlsx")
